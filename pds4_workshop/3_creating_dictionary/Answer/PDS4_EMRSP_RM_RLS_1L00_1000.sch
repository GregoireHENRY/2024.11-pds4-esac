<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:emrsp_rm_rls  Version:1.0.0.0 - Thu Oct 31 15:45:09 CET 2024 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="emrsp_rm_rls:Autofocus_Data/emrsp_rm_rls:laser_channel">
      <sch:assert test=". = ('1', '2')">
        ...
        The attribute emrsp_rm_rls:Autofocus_Data/emrsp_rm_rls:laser_channel must be equal to one of the following values '1', '2'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="emrsp_rm_rls:Instrument_Status/emrsp_rm_rls:rotation_angle">
      <sch:assert test="@unit = ('arcmin', 'arcsec', 'deg', 'hr', 'microrad', 'mrad', 'rad')">
        <title>emrsp_rm_rls:Instrument_Status/emrsp_rm_rls:rotation_angle/emrsp_rm_rls:rotation_angle</title>
